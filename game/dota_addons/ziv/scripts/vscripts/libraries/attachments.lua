...
--[[
  ...
  -Additionally, ensure that you have the ziv_attachments.xml, ziv_attachments.js, and ziv_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure ziv)", FCVAR_CHEAT )
