...
if testCount == nil then
  if not enigma then
    ...
    enigma:FindAbilityByName("ziv_dummy_unit"):SetLevel(1)
    ...
    planet1:FindAbilityByName("ziv_dummy_unit"):SetLevel(1)
    ...
    planet2:FindAbilityByName("ziv_dummy_unit"):SetLevel(1)
    ...
    planet3:FindAbilityByName("ziv_dummy_unit"):SetLevel(1)
...
if testCount == 3 then
  ...
  Timers:CreateTimer("timer", {
    callback = function()
      ...
      unit:FindAbilityByName("ziv_dummy_unit"):SetLevel(1)
